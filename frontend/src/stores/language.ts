...
export const useLanguageStore = defineStore('language', () => {
  ...
  const translations = {
    en: {
      ...
      maxUrlsReached: 'Maximum of 5 URLs reached. Remove one to save a new URL.',
      removeUrl: 'Remove',
      maxUrlsReachedTitle: 'Maximum URLs Reached',
      maxUrlsReachedMessage:
        'You have reached the maximum of 5 saved URLs. Please remove one to save a new URL.',
    ...
    es: {
      ...
      maxUrlsReached: 'Máximo de 5 URLs alcanzado. Elimina una para guardar una nueva URL.',
      removeUrl: 'Eliminar',
      maxUrlsReachedTitle: 'Máximo de URLs Alcanzado',
      maxUrlsReachedMessage:
        'Has alcanzado el máximo de 5 URLs guardadas. Por favor, elimina una para guardar una nueva URL.',
