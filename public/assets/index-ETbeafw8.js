const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/Results-CqqJvh7R.js', 'assets/vendor-DiATmvVG.js'])
) => i.map((i) => d[i]);
import {
  d as M,
  r as C,
...
const fe = M('theme', () => {
      ...
      return (o, l) => (
        ...
        I('header', null, [
          e('div', be, [
            ...
            t.value ? (L(), I('div', ve, [e('div', ye, [T(W), T(D)])])) : $('', !0),
          ]),
          e('div', ke, [
            l[1] ||
              (l[1] = e(
  ...
  Ne = S({
    ...
    setup(d) {
      ...
      function f() {
        ((l.value = !l.value),
          l.value
            ? window.openWcagModal && window.openWcagModal()
            : window.closeWcagModal && window.closeWcagModal());
      }
      async function g() {
        if (a.value.trim()) {
  ...
  Qe = S({
    __name: 'App',
    setup(d) {
      const s = ae(() => se(() => import('./Results-CqqJvh7R.js'), __vite__mapDeps([0, 1]))),
        r = B(),
        t = A(() => !!r.results),
        a = A(() => r.results);
      return (o, l) => (
