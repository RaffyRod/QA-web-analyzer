const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/Results-DjS5YU1I.js', 'assets/vendor-CR1X3c2X.js'])
) => i.map((i) => d[i]);
import {
  d as R,
  r as _,
...
const fe = R('theme', () => {
      ...
      return (o, r) => (
        ...
        I('header', null, [
          e('div', be, [
            ...
            t.value
              ? (L(), I('div', ve, [e('div', ye, [T(W, { mobile: !0 }), T(D, { mobile: !0 })])]))
              : j('', !0),
          ]),
          e('div', ke, [
            r[1] ||
  ...
  Qe = S({
    __name: 'App',
    setup(d) {
      const s = ae(() => se(() => import('./Results-DjS5YU1I.js'), __vite__mapDeps([0, 1]))),
        l = B(),
        t = C(() => !!l.results),
        a = C(() => l.results);
      return (o, r) => (
