const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/Results-D8FuOlr_.js', 'assets/vendor-DiATmvVG.js'])
) => i.map((i) => d[i]);
import {
  d as P,
  r as C,
...
(function () {
  ...
  new MutationObserver((a) => {
    for (const o of a)
      if (o.type === 'childList')
        for (const l of o.addedNodes) l.tagName === 'LINK' && l.rel === 'modulepreload' && t(l);
...
const re = 'modulepreload',
  ...
  se = function (s, r, t) {
          ...
          if (
            ...
            return new Promise((_, w) => {
              (p.addEventListener('load', _),
                p.addEventListener('error', () => w(new Error(`Unable to preload CSS for ${g}`))));
            });
        })
      );
    }
    ...
    return a.then((l) => {
      for (const f of l || []) f.status === 'rejected' && o(f.reason);
      return s().catch(o);
    });
  },
  O = P('language', () => {
    const d = C(localStorage.getItem('language') || 'en'),
      s = {
        en: {
    ...
    return { currentLanguage: d, translations: s, setLanguage: r, t };
  }),
...
const fe = P('theme', () => {
    const d = C(localStorage.getItem('theme') || 'light');
    function s(t) {
      (U[t] || (t = 'light'), (d.value = t), localStorage.setItem('theme', t));
      const a = U[t],
        o = document.documentElement;
      (Object.keys(a).forEach((v) => {
        v !== 'name' && o.style.setProperty(v, a[v]);
      }),
        document.body.setAttribute('data-theme', t));
      const l = a['--primary-color'] || '#3b82f6',
        f = R(l),
        g = f ? '#1e293b' : '#ffffff';
      o.style.setProperty('--button-text-color', g);
      const k = f ? '#1e293b' : '#ffffff';
      (o.style.setProperty('--modal-header-text-color', k),
        o.style.setProperty(
          '--modal-close-bg',
    ...
    function r(t, a, o) {
      document.querySelectorAll('.theme-option[data-selected="true"]').forEach((f) => {
        ...
        if (g.dataset.theme === t) {
          ...
          const k = o ? '#1e293b' : '#ffffff';
          g.style.setProperty('color', k, 'important');
        }
      });
    }
    return (
  ...
  W = S({
    ...
    setup(d) {
      ...
      function k(_) {
        (r.applyTheme(_), (o.value = !1));
      }
      function v(_, w) {
        if (_ === f.value) {
          const y = w['--primary-color'] || '#3b82f6',
            m = R(y);
          return { background: y, color: m ? '#1e293b' : '#ffffff' };
        }
        return {};
      }
      function p(_) {
        ...
        y && m && !y.contains(w) && !m.contains(w) && (o.value = !1);
      }
      return (
        $(f, () => {
          setTimeout(() => {
            document.querySelectorAll('.theme-option').forEach((w) => {
              const y = w,
                m = y.dataset.theme;
              if (m && l.value[m]) {
                const h = l.value[m];
        ...
        (_, w) => (
          ...
          I('div', pe, [
            ...
            e(
              'div',
              { id: c(a), class: N(['theme-dropdown', { hidden: !o.value }]) },
              [
                (L(!0),
                I(
                  K,
      ...
      return (o, l) => (
        ...
        I('header', null, [
          e('div', be, [
            ...
            t.value ? (L(), I('div', ve, [e('div', ye, [T(D), T(W)])])) : M('', !0),
          ]),
          e('div', ke, [
            l[1] ||
              (l[1] = e(
            ...
            e('h1', null, u(c(r)('title')), 1),
          ]),
          e('p', we, u(c(r)('subtitle')), 1),
        ])
      );
    },
  }),
    ...
    async function a(f) {
      ...
      try {
        ...
        if (!g.ok) {
          ...
          throw new Error(v.message || 'Analysis failed');
        }
        const k = await g.json();
        s.value = k;
      } catch (g) {
        ((r.value = g.message || 'Failed to analyze page'), (s.value = null));
      } finally {
        d.value = !1;
      }
    }
  ...
  Re = { class: 'option-group-header' },
  Pe = { class: 'radio-group' },
  Ve = ['checked'],
  $e = ['checked'],
  Me = { class: 'checkbox-group' },
  Be = S({
    __name: 'OptionsPanel',
    setup(d) {
      const s = B(),
        ...
        { t } = r,
        a = A(() => s.options),
        o = A(() => ['checkImages', 'checkLinks', 'checkButtons', 'checkInputs', 'checkRoles']),
        l = A(() => [
          'checkAltText',
          'checkAriaLabel',
          'checkAriaLabelledby',
        ...
        f = A(() => o.value.every((h) => a.value[h])),
        g = A(() => o.value.every((h) => !a.value[h])),
        k = A(() => l.value.every((h) => a.value[h])),
        v = A(() => l.value.every((h) => !a.value[h]));
      function p() {}
      function _() {
        const h = {};
        (o.value.forEach((n) => {
                ...
                e('div', Ie, [
                  ...
                  e('div', Te, [
                    e('label', null, [
                      e(
                        'input',
                        { type: 'radio', name: 'elements', checked: f.value, onChange: _ },
                        null,
                        40,
                        Se
                      ),
                    ...
                    e('label', null, [
                      e(
                        'input',
                        { type: 'radio', name: 'elements', checked: g.value, onChange: w },
                        null,
                        40,
                        Ee
                      ),
                ...
                e('div', Re, [
                  ...
                  e('div', Pe, [
                    e('label', null, [
                      e(
                        'input',
                        { type: 'radio', name: 'attributes', checked: k.value, onChange: y },
                        null,
                        40,
                        Ve
                      ),
                    ...
                    e('label', null, [
                      e(
                        'input',
                        { type: 'radio', name: 'attributes', checked: v.value, onChange: m },
                        null,
                        40,
                        $e
                      ),
  ...
  G = (d, s) => {
    ...
    for (const [t, a] of s) r[t] = a;
    return r;
  },
  qe = G(Be, [['__scopeId', 'data-v-b9adb488']]),
  ze = S({
    ...
    setup(d) {
      ...
      return (
        V(() => {
          (document.addEventListener('keydown', a), (window.openWcagModal = r));
        }),
        F(() => {
          (document.removeEventListener('keydown', a), delete window.openWcagModal);
        }),
        (o, l) =>
          s.value
            ? (L(),
                ...
                [
                  ...
                  e('div', { class: 'wcag-modal-content' }, [
                    e('div', { class: 'wcag-modal-header' }, [
                      l[0] || (l[0] = e('h4', null, 'WCAG 2.2 AA Accessibility Guidelines', -1)),
                      e(
                        'button',
                        {
                          id: 'wcagInfoClose',
  ...
  Ne = S({
    ...
    setup(d) {
      const s = B(),
        ...
        l = C(!1);
      function f() {
        ((l.value = !l.value), l.value && window.openWcagModal && window.openWcagModal());
      }
      async function g() {
        if (a.value.trim()) {
  ...
  Qe = S({
    __name: 'App',
    setup(d) {
      const s = ae(() => se(() => import('./Results-D8FuOlr_.js'), __vite__mapDeps([0, 1]))),
        r = B(),
        t = A(() => !!r.results),
        a = A(() => r.results);
      return (o, l) => (
            ...
            ? (L(),
              ee(
                ...
                { key: 0 },
                {
                  ...
                  fallback: q(() => [
                    ...(l[0] ||
                      (l[0] = [e('div', { class: 'loading' }, 'Loading results...', -1)])),
                  ]),
                  _: 1,
                }
              ))
  ...
  Je = G(Qe, [['__scopeId', 'data-v-bd4ee5e9']]),
  j = oe(Je),
  Xe = ne();
j.use(Xe);
j.mount('#app');
