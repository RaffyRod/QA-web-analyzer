const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/Results-hDMDmg-G.js', 'assets/vendor-DJJw8Pl3.js'])
) => i.map((i) => d[i]);
import {
  d as O,
  r as v,
...
const ie = O('theme', () => {
  ...
  de = { class: 'theme-selector' },
  fe = ['id', 'aria-expanded'],
  pe = ['id'],
  ue = ['data-theme', 'data-selected', 'onClick'],
  z = T({
      ...
      return (
        ...
        (d, w) => (
          ...
          C('div', de, [
            ...
            e(
              'div',
              { id: i(a), class: N(['theme-dropdown', { hidden: !n.value }]) },
              [
                (k(!0),
                C(
                  G,
  ...
  he = { class: 'header-top' },
  be = { class: 'header-controls desktop-controls' },
  ge = ['aria-expanded'],
  xe = { key: 0, id: 'mobileMenu', class: 'mobile-menu' },
  me = { class: 'mobile-menu-content' },
  ye = { class: 'header-title-group' },
  ve = { class: 'subtitle' },
  ke = T({
    __name: 'Header',
    setup(f) {
      ...
      return (n, c) => (
        ...
        C('header', null, [
          e('div', he, [
            ...
            t.value ? (k(), C('div', xe, [e('div', me, [I(P), I(z)])])) : q('', !0),
          ]),
          e('div', ye, [
            c[1] ||
              (c[1] = e(
  ...
  we = { class: 'options-section' },
  Ae = { class: 'options-container' },
  Ce = { class: 'option-group' },
  _e = { class: 'option-group-header' },
  Le = { class: 'radio-group' },
  Ie = ['checked'],
  Te = ['checked'],
  Se = { class: 'checkbox-group' },
  Ee = { class: 'option-group attributes-group' },
  Ue = { class: 'option-group-header' },
  Oe = { class: 'radio-group' },
  Re = ['checked'],
  Ve = ['checked'],
                    ...
                    b(
                      e(
                        'input',
                        {
                          id: 'checkAriaLabel',
                          'onUpdate:modelValue':
                            o[6] || (o[6] = (s) => (a.value.checkAriaLabel = s)),
                          type: 'checkbox',
                          onChange: d,
                        },
                        null,
                    ...
                    b(
                      e(
                        'input',
                        {
                          id: 'checkLabels',
                          'onUpdate:modelValue':
                            o[17] || (o[17] = (s) => (a.value.checkLabels = s)),
                          type: 'checkbox',
                          onChange: d,
                        },
                        null,
  ...
  Pe = H(Be, [['__scopeId', 'data-v-b9adb488']]),
  ze = { class: 'input-section' },
  Me = { class: 'input-group' },
  De = ['placeholder'],
  Fe = { class: 'button-group' },
  qe = ['disabled'],
  He = T({
    __name: 'AnalysisForm',
    setup(f) {
  ...
  je = T({
    __name: 'App',
    setup(f) {
      const l = Y(() => oe(() => import('./Results-hDMDmg-G.js'), __vite__mapDeps([0, 1]))),
        r = R(),
        t = y(() => !!r.results),
        a = y(() => r.results);
      return (n, c) => (
  ...
  Ne = H(je, [['__scopeId', 'data-v-bd4ee5e9']]),
  W = ee(Ne),
  Ge = ae();
W.use(Ge);
W.mount('#app');
