...
- ✅ **Todos los Atributos Requeridos**: Cuando se seleccionan múltiples atributos para validación, los elementos deben tener TODOS los atributos seleccionados para pasar. Si falta cualquier atributo seleccionado, el elemento se marca como "FALLÓ". Esto asegura una validación exhaustiva al verificar múltiples requisitos de accesibilidad
